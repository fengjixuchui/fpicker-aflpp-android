...
ifneq "$(filter Linux GNU%,$(SYS))" ""
 ifndef DEBUG
  override CFLAGS += -D_FORTIFY_SOURCE=2 -DUSEMMAP=0
 endif
  LDFLAGS +=  -L/home/mk/lib -L/home/mk/x86_64/sysroot/usr/lib/x86_64-linux-android/31 -ldl  -lm -llog  -landroid-shmem
endif
